    ...
    <section className="px-4 py-16 md:py-24 min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          {/* Right Side / Below on Mobile - iPhone Mockup Placeholder */}
          <div className="flex justify-center md:justify-end order-first md:order-last">
            <div className="w-full max-w-xs md:max-w-sm">
              <div className="aspect-[9/16] bg-gray-800 border-2 border-gray-700 rounded-3xl p-2 shadow-2xl relative overflow-hidden">
                ...
                <div className="w-full h-full bg-gradient-to-br from-gray-900 to-black rounded-2xl flex items-center justify-center relative">
                  ...
                  <div className="w-full h-full flex flex-col items-center justify-center p-4 md:p-6">
                    <div className="w-full aspect-square bg-gradient-to-br from-purple-600/30 to-cyan-600/30 rounded-xl mb-3 md:mb-4 flex items-center justify-center border border-gray-700">
                      <p className="text-gray-400 text-xs text-center px-2 md:px-4">
                        Spotify Canvas<br />Video<br />Placeholder
                      </p>
                    </div>
                    <div className="text-center">
                      <p className="text-white text-xs md:text-sm font-semibold mb-1">Now Playing</p>
                      <p className="text-gray-400 text-xs">Track Title</p>
                    </div>
                  </div>
                </div>
              </div>
              <p className="text-xs text-gray-500 text-center mt-3 md:mt-4">
                iPhone Spotify Canvas mockup (video placeholder)
              </p>
            </div>
          </div>
        </div>
