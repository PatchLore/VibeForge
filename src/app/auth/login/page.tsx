          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full px-4 py-3 pr-12 rounded-xl bg-white/20 border border-white/30 transition-all duration-200 text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-400"
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="flex items-center justify-center px-4 py-3 border border-white/20 rounded-xl bg-white/10 text-white hover:bg-white/20 transition-all"
            >
